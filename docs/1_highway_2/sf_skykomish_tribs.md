...
## Tackle (the constraint-shaped kit)

✅ **Will work:**
* **Inline spinners** (Rooster Tails, Mepps Aglia #0–#1, Panther Martin) — **with trebles crushed barbless OR replaced with single siwash hooks** (~$0.50 each at any tackle shop)
* **Small spoons** (Kastmaster 1/12–1/8 oz, Little Cleo) — same hook conversion
* **Bubble + fly rig** — fits selective gear cleanly. Small dries (Parachute Adams, Elk Hair Caddis) or wets (soft hackles, small streamers)
* **Existing Fenwick 6.5' Light + Okuma 2500 + 4 lb fluoro leader** = right setup, no change needed

❌ **Leave in the car:**
* PowerBait dough / Power Eggs / Mice Tails / Trout Worms — all scented, all illegal here
* Gulp! / Berkley scented soft plastics — same
* Sand shrimp, worms, salmon eggs
* Anything with treble hooks unless converted

## Scouting Report

* **Reading the water:** Cast upstream and slightly across; retrieve back with the current. Trout hold at heads/tails of pools, behind boulders, and in seams where fast water meets slow.
* **14" minimum is real:** Most resident cutthroat in these streams run 8–12". You'll catch fish, but **keepers (cutthroat and wild rainbow ≥14") are uncommon.** Hatchery rainbows (fin-clipped) follow the lower statewide minimum, but stocking density on these tribs is modest.
* **Best windows:** First two weeks of season after the runoff drops and clears; then mornings/evenings in late June.
* **Bushwhack factor:** Plenty of brush. Wear pants, bring polarized glasses, and a long-billed hat for casting under cover.

## Logistics

| Attribute | Detail |
| :--- | :--- |
| **Access** | Beckler River Rd (FR 65) north from Skykomish for Beckler; FR 68 area for Foss; FR 6412 area for Rapid; FR 6420 for Miller. Multiple pullouts and trail accesses. |
| **Pass Required** | Northwest Forest Pass at some USFS trailheads / parking areas |
| **License** | WA freshwater fishing license + Catch Record Card if you accidentally hook (and immediately release) a steelhead |
| **Best season** | Late May / June (within the Sat-before-Memorial-Day to July 10 window) |
| **Land** | Mt. Baker-Snoqualmie National Forest |

## Field Notes
* _Track which trib produced what, hook conversion experience (siwash swap vs barb-crush), and any bull trout encounters (note location, release condition)._
